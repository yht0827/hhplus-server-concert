...
public interface PaymentAPI {
	...
	@ApiResponses(value = {
		@ApiResponse(responseCode = "200", description = "좌석 결제 성공",
			content = @Content(mediaType = "application/json", schema = @Schema(implementation = PaymentConcertResponse.class)))})
	ResponseEntity<PaymentConcertResponse> paymentConcert(
