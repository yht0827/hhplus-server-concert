...
public interface PointAPI {
	...
	@ApiResponses(value = {
		@ApiResponse(responseCode = "200", description = "포인트 조회 성공",
			content = @Content(mediaType = "application/json", schema = @Schema(implementation = SearchPointResponse.class)))})
	ResponseEntity<SearchPointResponse> getPoint(@PathVariable final Long pointId);
